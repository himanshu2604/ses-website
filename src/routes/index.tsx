      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 space-y-14">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {gates.map((g) => (
            <div
              key={g.num}
              className="bg-[#111] border border-[#1e1e1e] rounded-[4px] p-6 md:p-8 flex flex-col"
            >
          ...
          <div className="lg:hidden flex flex-col items-center gap-2">
            {steps.map((s, idx) => (
              <div key={s} className="flex flex-col items-center w-full max-w-[200px]">
                <div className="bg-[#111] border border-[#1e1e1e] rounded-[4px] px-4 py-2.5 text-center text-[12px] mono text-[#888] font-medium w-full">
                  {s}
                </div>
                {idx < steps.length - 1 && (
