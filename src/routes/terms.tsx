...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Terms of service for Software Evolution Service subscriptions.",
      },
...
const sections: Array<{ title: string; body: string }> = [
  {
    title: "1. The service",
    body: "Software Evolution Service (SES) provides weekly AI-assisted software improvement as a subscription. Each engagement begins with a free baseline audit. Paid plans commence upon written agreement and payment of the first month.",
  },
  {
  ...
  },
  {
    ...
    body: "Access to your code repository (read/write for PRs), a staging environment for verification, and a designated reviewer with merge authority. We do not require production access beyond your product URL.",
  },
  {
    title: "4. Payment",
  ...
  },
  {
    ...
    body: "All code delivered via pull requests becomes your property upon merge. We retain no rights to your codebase or derived works. Our methodology, Health Score algorithm, and tooling remain proprietary to SES.",
  },
  {
    title: "6. Limitation of liability",
    body: "SES is not liable for incidents, data loss, or downtime arising from merged pull requests. All PRs are reviewed and approved by your designated reviewer before production deployment — merge authority rests with your team, not ours.",
  },
  {
